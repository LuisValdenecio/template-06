    ...
    <footer className="pt-32 sm:pt-44">
        <div className="custom-screen text-gray-600">
                ...
                <div className="space-y-4">
                    <Link href="/" className="inline-block">
                        <p className="text-xl font-bold">
                            {process.env.NEXT_PUBLIC_BOOK_LOGO}
                        </p>
                    </Link>
            ...
            <div className="mt-10 py-10 border-t flex-row-reverse items-center justify-between sm:flex">
                ...
                <p className="mt-6 sm:mt-0">© {process.env.NEXT_PUBLIC_FOOTER_YEAR} {process.env.NEXT_PUBLIC_FOOTER_COPYRIGHT}. All rights reserved.</p>
            </div>
        </div>
    </footer>
)
